...
export default function SelectedWork() {
  ...
  const projects = [
    ...
    {
      title: 'KS Meubles',
      category: t['work.ksmeubles.category'],
      desc: t['work.ksmeubles.desc'],
      url: 'https://ks-meubles-demo.surge.sh',
      image: '/projects/ksmeubles.png',
      tags: ['React', 'Tailwind', 'E-commerce'],
      color: '#8B5CF6',
      year: '2025',
      highlight: t['work.ksmeubles.highlight'],
    },
    {
      title: 'Nubis.app',
